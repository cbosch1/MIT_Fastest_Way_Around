...
class Digraph(object):
    ...
    def add_node(self, node):
        ...
        for stored_node in self.nodes:
            ...
            if stored_node.get_name() == node.get_name():
    ...
    def add_edge(self, edge):
        ...
        for stored_node in self.nodes:
            ...
            if stored_node.get_name() == start.get_name():

                start_present = True

            if stored_node.get_name() == end.get_name():
        ...
        if start_present and end_present:
            ...
            raise ValueError("One or more of the Nodes is missing from this edge")
